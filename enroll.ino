...
String PATH_NAME   = "/dht11_project/fingerPrint_database.php";
String queryString= "";
...
uint8_t getFingerprintEnroll() {
  ...
  if (p == FINGERPRINT_OK) {
    ...
    queryString = "?ID=" + id_string + "&Student_id=" + Sid_string;
...
uint8_t getFingerprintID() {
  ...
  if (p == FINGERPRINT_OK) {
    ...
    digitalWrite(5,LOW);delay(200);digitalWrite(5,HIGH);delay(2000);
    digitalWrite(5,LOW);
  } else if (p == FINGERPRINT_PACKETRECIEVEERR) {
    Serial.println("Communication error");
    return p;
    ...
    digitalWrite(2,LOW);delay(200);digitalWrite(2,HIGH);delay(2000);
    digitalWrite(2,LOW);
    return p;
  } else {
    Serial.println("Unknown error");
